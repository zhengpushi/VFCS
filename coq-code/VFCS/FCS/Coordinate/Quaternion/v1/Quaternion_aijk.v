(*
  ...
  2. What difference between Notation and Definition?
    Notation look like a macro in C, Coq make no different with original type.
...
From FCS Require Export Utils.RingFieldStruct.RingType.
Import Utils.RingFieldStruct.RingType.

(* --------------------------------------------------------------- *)
(* Definitions and operations of Quaternion *)

Module Module_Quaternion_aijk (RT : RingType).
  Export RT.
...
Module Module_Quaternion_aijk_Z.
  Module Quaternion_aijk_Z := Module_Quaternion_aijk RingTypeZ.
