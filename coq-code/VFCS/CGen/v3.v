...
| DVint (i : Z)
| DVfloat (f : R)
| DVvec (t : DataType) (n : nat) (v : @vec DataValue n)
...
Fixpoint DataValueDef (t : DataType) : DataValue :=
  ...
  | DTint => DVint 0
  | DTfloat => DVfloat R0
  | DTvec t n => DVvec t n (f2v _ n (fun i => DataValueDef t))
...
Section test.
  ...
  Compute DVint 5.
  Compute DVfloat R1.
  Compute DVvec DTint 3 (l2v _ 3 (DataValueDef DTint) [DVint 1; DVint 2; DVint 3]).
