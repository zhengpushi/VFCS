...
Require Export MatrixRfun.

Open Scope Rfun_scope.
Open Scope mat_scope.


Module Export RowVectorRfun.
  ...
  Lemma rvcmul_assoc : forall {n} a b (v : rvec n), a c* (b c* v) == (a * b)%F c* v.
  ...
  Section test.
    ...
    (* Eval cbn in rv2l (rvmap fopp v2). *)
    (* Eval cbv in rv2l (rvmap fopp v2). *)
  End test.

End RowVectorRfun.


Module Export ColVectorRfun.
  ...
  Lemma cvcmul_assoc : forall {n} a b (v : cvec n), a c* (b c* v) == (a * b)%F c* v.
  ...
  Section test.
    ...
    (* Eval cbn in cv2l (cvmap fopp v2). *)
    (* Eval cbv in cv2l (cvmap fopp v2). *)
