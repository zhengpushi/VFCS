...
Module Export RowVectorC.
  ...
  Lemma rvcmul_assoc : forall {n} a b (v : rvec n), a c* (b c* v) == (a * b)%C c* v.
  ...
  Section test.
    ...
    (* Eval cbn in rv2l (rvmap Copp v2). *)
  End test.

End RowVectorC.


Module Export ColVectorC.
  ...
  Lemma cvcmul_assoc : forall {n} a b (v : cvec n), a c* (b c* v) == (a * b)%C c* v.
  ...
  Section test.
    ...
    (* Eval cbn in cv2l (cvmap Copp v2). *)
