...
(** *** vector addition *)
Definition vadd {n} (v1 v2 : vec n) : vec n := vadd v1 v2 (Aadd:=Z.add).
...
(** *** vector opposition *)
Definition vopp {n} (v : vec n) : vec n := vopp v (Aopp:=Z.opp).
...
(** *** vector subtraction *)
Definition vsub {n} (v1 v2 : vec n) : vec n := vsub v1 v2 (Aadd:=Z.add) (Aopp:=Z.opp).
Infix "-" := vsub : vec_scope.

(** *** vector scalar multiplication *)
Definition vcmul {n} a (v : vec n) : vec n := vcmul a v (Amul:=Z.mul).
...
(** *** vector dot product *)
Definition vdot {n} (v1 v2 : vec n) := vdot v1 v2 (Aadd:=Z.add)(A0:=0)(Amul:=Z.mul).
