...
From CoqMatrix Require Complex QExt.
From CoqMatrix Require SafeNatFun.Vector.
From CoqMatrix Require VectorR VectorC.
...
Section field.
  Import QExt.
  Goal forall a b c : Q, a + b + c == c + b + a.
  Proof. apply ExTheorem1. Qed.
...
Section vector_space.
  ...
  Class VectorSpace {n} (VS0 : @vec A n)
    ...
    := {
      VSadd_comm :> Commutative VSadd veq;
